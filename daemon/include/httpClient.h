...
class HttpClient{
	...
	public:
		...
		int copy(const std::string &token, const std::string &strUrl, std::string &strResponse, const char *pCaPath=NULL);
	...
	public:
		...
		virtual int file_upload(const std::string &strFilename, const std::string &uuid, const std::string &token, const std::string &strUrl, std::string &strResponse){};
